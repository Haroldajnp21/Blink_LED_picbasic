...
ram_bank = 2
    clrf CM1CON0
    clrf CM2CON0
F1_000025 equ $ ; IN [BLINK_LED.BAS] TRISA=0
    bsf STATUS,5
    bcf STATUS,6
ram_bank = 1
    clrf TRISA
F1_000026 equ $ ; IN [BLINK_LED.BAS] TRISB=0
    clrf TRISB
F1_000027 equ $ ; IN [BLINK_LED.BAS] PORTB=0
    bcf STATUS,5
ram_bank = 0
    clrf PORTB
Inicio
F1_000030 equ $ ; IN [BLINK_LED.BAS] PORTB.0=0
    bcf PORTB,0
F1_000031 equ $ ; IN [BLINK_LED.BAS] DELAYMS 500
    movlw 0X01
    movwf PP1H
    movlw 0XF4
    f@call __delay_ms_w_
ram_bank = 0
F1_000032 equ $ ; IN [BLINK_LED.BAS] PORTB.0=1
    bsf PORTB,0
F1_000033 equ $ ; IN [BLINK_LED.BAS] DELAYMS 500
    movlw 0X01
    movwf PP1H
    movlw 0XF4
    f@call __delay_ms_w_
ram_bank = 0
F1_000034 equ $ ; IN [BLINK_LED.BAS] GOTO INICIO
    f@jump Inicio
F1_000036 equ $ ; IN [BLINK_LED.BAS] END
_pblb__2
    f@jump _pblb__2
F1_EOF equ $ ; BLINK_LED.BAS
_pblb__3
    f@jump _pblb__3
__EOF
